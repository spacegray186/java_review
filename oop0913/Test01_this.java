...
class Score {
	//멤버변수 field
	private String name="손길동";
	private int kor, eng, mat;
	private int aver;
	
	//생성자함수 constructor
	//생성자함수를 오버로딩하면 기본생성자 함수는 자동으로 생성되지 않는다
	//그래서, 기본 생성자함수는 수동으로 생성할 것을 추천!!
	public Score() {}
	...
	public void disp() {
		//지역변수의 우선순위가 가장 높다
		String name="박길동";
		System.out.println(name);		//박길동
		
		System.out.println(this.name);	//손길동	this.멤버변수
...
public class Test01_this {
	...
	public static void main(String[] args) {
		...
		Score one=new Score("김연경", 50, 60, 75);
		one.disp();
